...
{
    m_window->GenerateNativeWindow();
    NS::Window* nativeWindow = m_window->GetNativeWindow();

    nativeWindow->setTitle(NS::String::string("00 - Window", NS::StringEncoding::UTF8StringEncoding));
